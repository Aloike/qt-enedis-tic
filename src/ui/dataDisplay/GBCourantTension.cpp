...
void    GBCourantTension::clear()
{
    ...
    this->ui->UMOY1Timestamp->setText(c_strNoDataTimestamp);
    this->ui->UMOY1Value->setText(c_strNoData3V);
    this->ui->UMOY2Timestamp->setText(c_strNoDataTimestamp);
    this->ui->UMOY2Value->setText(c_strNoData3V);
    this->ui->UMOY3Timestamp->setText(c_strNoDataTimestamp);
